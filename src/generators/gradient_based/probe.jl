...
function ProbeGenerator(; λ::AbstractFloat = 0.1, loss::Symbol = :mse, penalty = distance_l1, kwargs...)
	...
	println("loaded probe")
	return Generator(; loss = combined_loss, penalty = penalty, λ = λ, kwargs...)
end
