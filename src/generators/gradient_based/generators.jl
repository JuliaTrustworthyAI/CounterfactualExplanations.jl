const default_distance = Objectives.distance_mad
...
function GreedyGenerator(; λ::AbstractFloat=0.1, η=0.1, n=nothing, kwargs...)
    opt = CounterfactualExplanations.Generators.JSMADescent(; η=η, n=n)
    return Generator(; penalty=default_distance, λ=λ, opt=opt, kwargs...)
end
