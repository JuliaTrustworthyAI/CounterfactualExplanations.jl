...
## Towards Trustworthy Artificial Intelligence {auto-animate=true auto-animate-easing="ease-in-out"}
...
::: {data-id="box2" style="background: #3fb618; width: 200px; height: 150px; margin: 10px; opacity: 0.5"}
Probabilistic Models
:::

::: {data-id="box1" style="background: #2780e3; width: 200px; height: 150px; margin: 10px; opacity: 0.5"}
Counterfactual Reasoning
:::
:::

- The journey towards Trustworthy AI starts with trustworthy data ...

## Towards Trustworthy Artificial Intelligence {auto-animate=true auto-animate-easing="ease-in-out"}

::: {.r-hstack}
::: {data-id="box3" style="background: #e83e8c; width: 200px; height: 150px; margin: 10px; opacity: 0.5"}
Data
:::
...
![Generating a counterfactual for 🐱 following @schut2021generating. The contour shows the predictions of a simple MLP with Laplace Approximation.](https://raw.githubusercontent.com/pat-alt/CounterfactualExplanations.jl/main/docs/src/www/recourse_laplace.gif){#fig-cat-laplace}
