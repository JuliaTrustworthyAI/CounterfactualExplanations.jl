...
model_loaded = CounterfactualExplanations.Models.pytorch_model_loader("$(pwd())/dev/python_implementation_test", "nn", "NeuralNetwork", "$(pwd())/dev/pytorch_test/nn_test.pt")
...
println("here")
model = PythonCall.pyimport("nn" => "NeuralNetwork")()
