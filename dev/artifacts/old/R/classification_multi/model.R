run_model <- function(artifact_path,root="dev/artifacts/R/classification_multi") {
  library(torch)
  set.seed(1)
  ...
  save_dir <- file.path(artifact_path,"classification_multi")
  dir.create(save_dir)
