...
```{julia}
# Define a generator:
generator = CounterfactualExplanations.Models.GrowingSpheresGenerator(100, 0.01)

counterfactual = CounterfactualExplanations.growing_spheres_generation(
    generator,
    M_flux,
    x_random_factual,
    counterfactual_data
...
counterfactual = reshape(Float32.(counterfactual), (length(counterfactual), 1))

result = CounterfactualExplanations.feature_selection(
    M_flux,
    counterfactual_data,
    x_random_factual,
    counterfactual
