...
Among MLJ models, only the EvoTreeClassifier is supported thus far. Tuning the EvoTreeClassifier is very simple. As the first step, let's reload the dataset:
