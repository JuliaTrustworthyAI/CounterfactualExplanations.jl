...
x̅ = select_factual(counterfactual_data, 1) # factual
target = round(probs(la, x̅)) == 1.0 ? 0.0 : 1.0
generator = GenericGenerator()
counterfactual = generate_counterfactual(x̅, target, counterfactual_data, la, generator)
```
