...
biblio-style: juliacon
bibliography: ref.bib # https://raw.githubusercontent.com/pat-alt/bib/main/bib.bib
execute:
  eval: false
  echo: false
jupyter: julia-1.6
...
\begin{lstlisting}[language=Julia, escapechar=@,label={lst:generic}] 
# Data:
using CounterfactualExplanations, Random
Random.seed!(1234)
N = 100 # number of data points
