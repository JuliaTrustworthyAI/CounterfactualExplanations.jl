...
\hypertarget{sec-use}{%
\section{General usage}\label{sec-use}}
...
\subsubsection{A generic generator with
...
\subsection{Feature constraints}\label{feature-constraints}}
...
\subsubsection{Domain constraints}\label{domain-constraints}}
...
\subsection{Language interoperability}\label{language-interoperability}}
