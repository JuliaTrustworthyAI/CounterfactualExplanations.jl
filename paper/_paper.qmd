...
# Flux model setup: 
using Flux
y_train = Flux.onehotbatch(ys, counterfactual_data.y_levels)
...
# Specific image:
function from_digit_to_digit(from::AbstractArray, to::Number, generator, model; γ=0.8, x=X, y=ys, seed=1234, T=100)
...
# Specific digit:
function from_digit_to_digit(from::Number, to::Number, generator::Dict, model::Dict; γ=0.8, x=X, y=ys, seed=1234, T=100)
...
```{julia}
to = 4
counterfactuals = from_digit_to_digit(x,to,generators,models,T=5)
